            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">chapters</li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-400 w-5px h-2px"></span>
                        </li>
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{url('/admin/chapters/create')}}" class="btn btn-sm fw-bold btn-primary">Create</a>
                    <!--end::Primary button-->
                </div>
                <!--end::Actions-->
            </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="d-flex flex-wrap flex-stack pb-7">
                    ...
                    <div class="d-flex flex-wrap align-items-center my-1">
                        <h3 class="fw-bold me-5 my-1">chapters ({{$chapters->total()}})</h3>
                        <!--begin::Search-->
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="kt_project_users_table" class="table table-row-bordered table-row-dashed gy-4 align-middle fw-bold">
                                        ...
                                        <tr>
                                            <th>ID</th>
                                            <th class="min-w-250px">courseID</th>
                                            <th class="min-w-400px">Chapter Name</th>
                                            <th>Date</th>
                                        ...
                                        @foreach($chapters as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <a href="{{url('admin/courses/'.$item->course->id)}}" class="mb-1 text-gray-800 text-hover-primary">{{$item->course->title}}</a>
                                                        </div>
                                                        <!--end::Info-->
                                                    </div>
                                                    <!--end::User-->
                                                ...
                                                <td class="text-end">
                                                    <a href="{{url('admin/chapters/'.$item->id)}}" class="btn btn-info btn-sm">View</a>
