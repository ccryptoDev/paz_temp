            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">lessons</li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-400 w-5px h-2px"></span>
                        </li>
...
{{--                    <a href="{{url('/admin/lessons/create')}}" class="btn btn-sm fw-bold btn-primary">Create</a>--}}
{{--                    <!--end::Primary button-->--}}
{{--                </div>--}}
                <!--end::Actions-->
            </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="d-flex flex-wrap flex-stack pb-7">
                    ...
                    <div class="d-flex flex-wrap align-items-center my-1">
                        <h3 class="fw-bold me-5 my-1">lessons ({{$lessons->total()}})</h3>
                        <!--begin::Search-->
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="kt_project_users_table" class="table table-row-bordered table-row-dashed gy-4 align-middle fw-bold">
                                        ...
                                        <tr>
                                            <th>ID</th>
                                            <th class="min-w-250px">creator/lecturer</th>
                                            <th class="min-w-150px">Title</th>
                                            <th class="min-w-90px">price</th>
                                            <th class="min-w-90px">reviews</th>
                                            <th class="min-w-90px">likes</th>
                                            <th class="min-w-90px">showers</th>
                                            <th class="min-w-90px">level</th>
                                            <th>Date</th>
                                        ...
                                        @foreach($lessons as $course)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <a href="" class="mb-1 text-gray-800 text-hover-primary">{{$course->user->name}}</a>
                                                            <div class="fw-semibold fs-6 text-gray-400">{{$course->user->email}}</div>
                                                        </div>
                                                        <!--end::Info-->
                                                    </div>
                                                    <!--end::User-->
                                                ...
                                                <td>{{$course->likes}}</td>
                                                <td>{{$course->showers}}</td>
                                                <td>
                                                    <span class="badge badge-light-success fw-bold px-4 py-3">master</span>
                                                </td>
                                                <td>{{$course->created_at}}</td>
                                                <td class="text-end">
                                                    <a href="{{url('admin/lessons/'.$course->id)}}" class="btn btn-light btn-sm">View</a>
